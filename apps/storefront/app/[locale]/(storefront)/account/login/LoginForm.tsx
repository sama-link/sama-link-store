      ...
      >
        <form action={formAction} className="space-y-4" noValidate>
          ...
          <motion.button
            ...
            type="submit"
            disabled={isPending}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-brand py-3 text-sm font-semibold text-white shadow-sm transition-all hover:bg-brand-hover hover:shadow disabled:opacity-70 disabled:hover:scale-100"
          >
