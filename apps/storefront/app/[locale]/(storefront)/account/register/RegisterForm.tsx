...
import { Mail, Phone, MessageCircle, AlertCircle, Loader2, User, Lock } from "lucide-react";
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full rounded-xl border border-border bg-surface py-2.5 pl-9 pr-3 text-sm text-text-primary placeholder:text-text-muted transition-colors focus:border-brand focus:outline-none focus:ring-0 disabled:opacity-50"
                  placeholder="John"
                />
              </div>
            </div>
